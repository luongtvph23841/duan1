                        ...
                        <tr class="border-b-[1px] text-center font-semibold	">
                            ...
                            <td class="">
                                <div class="flex justify-center">
                                    <button type="submit" class="flex border w-[32px] h-[32px] text-[18px] items-center cursor-pointer justify-center hover:bg-[#d2a98b]">-</button>
                                    ...
                                    <button type="submit" class="flex border w-[32px] h-[32px] text-[15px] items-center cursor-pointer justify-center hover:bg-[#d2a98b]">+</button>
                                </div>
                            </td>

...
{
    $result = db_fetch_array("SELECT od.id, od.id_product, od.code, od.quantity, od.price_product, o.id_status, od.name_product, od.img_product, s.name_status FROM `order_detail` od

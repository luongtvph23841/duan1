            ...
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">Danh sách người dùng
                        <span class="d-block text-muted pt-2 font-size-sm">Danh sách các người dùng có trên hệ
                            thống</span>
                    </h3>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span style="overflow: visible; position: relative; width: 125px;">
                                        <a href="?role=admin&mod=orders&action=update&id_order=<?php echo $key['id'] ?>" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details"> <span class="svg-icon svg-icon-md"> <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
